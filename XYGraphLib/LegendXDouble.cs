...
namespace XYGraphLib {
  ...
  public class LegendXDouble: LegendX {
    ...
    ///// <summary>
    ///// Default constructor. A LegendXDouble is written parallel to the x-axis (horizontally) and shows per default x-values, 
    ///// which is dimension 1
    //public LegendXDouble()
    //  : this(Renderer.DimensionX) {
    //}


    ///// <summary>
    ///// Constructor if LegendXDouble should be used for another dimension than x, although still written parallel to the x-axis (horizontally)
    ///// </summary>
    //public LegendXDouble(int dimension)
    //  : base(dimension) {
    //}
    //#endregion
